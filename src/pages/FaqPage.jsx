...
const FAQS = [
  ...
  {
    q: 'هل يمكنني اختبار التيوريا قبل الدروس العملية؟',
    a: 'نعم، اختبار التيوريا (النظري) يسبق الدروس العملية. يمكنك التدرب على أسئلة التيوريا مجاناً من خلال قسم "الاختبار النظري" في موقعنا.',
  },
  {
  ...
  {
    q: 'كيف أتدرب على أسئلة التيوريا؟',
