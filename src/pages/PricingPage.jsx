...
const PLANS = [
  {
    ...
    features: ['10 دروس عملية (45 دقيقة)', 'اختبار التؤوريا النظري', 'مواد دراسة مجانية', 'تقرير تقدم أسبوعي'],
    missing: ['اختبار الطريق', 'ضمان النجاح'],
  },
  {
    icon: '🚀', name: 'الباقة الكاملة', desc: 'الخيار المثالي للأغلبية', price: 650, popular: true,
    features: ['20 درساً عملياً (45 دقيقة)', 'اختبار التؤوريا النظري', 'اختبار الطريق مع المدرب', 'مواد دراسة شاملة', 'دعم هاتفي 24/7'],
    missing: ['ضمان النجاح'],
  },
  {
    icon: '🏆', name: 'باقة الضمان', desc: 'للوصول إلى النجاح المضمون', price: 950, popular: false,
    features: ['دروس عملية غير محدودة', 'اختبار التؤوريا النظري', 'اختبار الطريق مع المدرب', 'ضمان النجاح أو استعادة المال', 'دعم VIP على مدار الساعة', 'تقرير أداء تفصيلي'],
    missing: [],
  },
]
